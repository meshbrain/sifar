...
You need the text gem. This is installed automatically if Sifar is installed as a gem. More information on sifar can be found at https://github.com/threedaymonk/text.
...
Any check can be used in combination with others.
